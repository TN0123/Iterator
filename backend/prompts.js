...
const designPrompt = `
    ...
    You want to end up with an incredibly high quality product that fulfills the user's request.
    ...
    3. Create Specifications: For each feature, provide a concise and clear specification that outlines its primary 
        function, inputs, and expected outputs. Focus on the "what", "why", and any ambiguities that should be resolved before implementation. 
        Identify assumptions the user may be making.
...
const instructPrompt = `
    ...
    try to have as few steps as possible while still being clear and detailed. You want to end up with an incredibly high quality 
    product that fulfills the user's request.
...
const generatePrompt = `
    You are an expert software engineer. You are working on a code generation task going step by step through an implementation plan.
    Your task is to complete the current given step in the implementation plan. Your goal is to create a perfectly working codebase and 
    incredible final product that fulfills the task requirements.
    ...
    Follow these guidelines:
    1) Fulfill the requirements of the current step exceptionally well, implementing complete, production-ready code.
    ...
    7) If there are multiple ways to solve a problem, choose the most maintainable, scalable, and clean option.
...
const reviewPrompt = `
    ...
    Pay attention to the correctness of the code in the files and make sure that the functions are correctly
    connected. Also make sure that the styling looks good.
    It is essential that the final product works perfectly, is high quality, and fulfills the task requirements. 
...
const revisePrompt = `
    ...
    your task is to revise the code based on the feedback provided. You want to do an exceptional job and make sure that 
